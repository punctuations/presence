...
export const TweetImage = (props: {
  ...
  return (
    ...
    >
      ...
      >
        {`@${
          props.tweet.includes?.users[0].username.length > 11
            ? `${props.tweet.includes?.users[0].username.slice(0, 11)}...`
            : props.tweet.includes?.users[0].username
        }`}
      </text>
      ...
      <g>
        <text
          ...
          fontWeight="bold"
        >
          {props.tweet.includes?.users[0].name === ""
            ? props.tweet.includes?.users[0].name
            : props.tweet.includes?.users[0].username}
        </text>
        {props.tweet.data && (
          <>
            {props.tweet.data.text.length > 84 ? (
              <>
                <text
                  fill={
                    !props.theme
                  ...
                  fontSize={36}
                >
                  {props.tweet.data.text.substring(0, 84)}
                </text>{" "}
                <text
                  fill={
                    !props.theme
                  ...
                  fontSize={36}
                >
                  {props.tweet.data.text.length >= 169
                    ? `${props.tweet.data.text.substring(84, 169)}`
                    : props.tweet.data.text.substring(84)}
                </text>{" "}
                <text
                  fill={
                    !props.theme
                  ...
                  fontSize={36}
                >
                  {props.tweet.data.text.length >= 253
                    ? `${props.tweet.data.text.substring(169, 253)}...`
                    : props.tweet.data.text.substring(169)}
                </text>{" "}
              </>
            ) : (
              <text
            ...
            <g>
              ...
              >
                {props.tweet.data?.public_metrics.reply_count! < 1000
                  ? numeral(
                      props.tweet.data?.public_metrics.reply_count
                    ).format("0a")
                  : numeral(
                      props.tweet.data?.public_metrics.reply_count
                    ).format("0.0a")}
            ...
            <g>
              ...
              >
                {props.tweet.data?.public_metrics.retweet_count! < 1000
                  ? numeral(
                      props.tweet.data?.public_metrics.retweet_count
                    ).format("0a")
                  : numeral(
                      props.tweet.data?.public_metrics.retweet_count
                    ).format("0.0a")}
      ...
      <image
        ...
        xlinkHref={`${
          props.tweet.includes?.users[0].profile_image_url.split("_normal")[0] +
          props.tweet.includes?.users[0].profile_image_url.split("_normal")[1]
        }`}
        width={350}
        height={390}
        x={105}
