...
export const Image = (props: {
  ...
  return (
    ...
    >
      ...
      {props.children}
      <g>
        {!data ? null : props.type === "github/user" && data.location ? (
          <g fill="#C4C4C4">
        ...
        <text fill="#646464" x={216} y={823} fontSize={40}>
          {!data
            ? null
            : props.type === "github/user" && data.location
            ? data.location
            : null}
        </text>

        {!data ? null : props.type === "github/user" && data.blog ? (
          <g fill="#C4C4C4">
        ...
        >
          {!data
            ? null
            : props.type === "github/user" && data.blog
            ? data.blog
            : null}
        </text>

        <g>
          {!data ? null : props.type === "github/user" && data.created_at ? (
            <g fill="#C4C4C4">
          ...
          <text fill="#646464" x={1342} y={823} fontSize={40}>
            {!data
              ? null
              : props.type === "github/user" && data.created_at
