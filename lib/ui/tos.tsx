  ...
  return (
    <section style={{ textAlign: "left" }}>
      ...
      <p>
        ...
        services or materials that may contain terms and conditions in addition
        to those in these Terms of Service. All such guidelines or rules are
        hereby incorporated by reference into these Terms of Service.
      </p>

      <p>
        These Terms of Service are effective as of <b>July 5th, 2021</b>. We
        expressly reserve the right to change these Terms of Service from time
        to time without notice to you. You acknowledge and agree that it is your
      ...
      <p>
        ...
        made by anyone other than an authorized <b>Presence</b> spokesperson
        speaking in his/her official capacity. Please refer to the specific
        editorial policies posted on various sections of this Website for
      ...
      <p>
        ...
        available for use in locations outside Canada, and accessing them from
      ...
      <p>
        ...
        the internal laws of the <b>ca</b> without giving effect to any choice
